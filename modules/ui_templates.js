...
<div id="wbap-panel" class="wbap-panel">
    <div class="wbap-panel-container">
        ...
        <div class="wbap-panel-content">
            ...
            <!-- 表格模块已废除
            <div class="wbap-section" id="wbap-table-section">
                <div class="wbap-section-header" style="align-items:center; gap:10px;">
                    <span class="wbap-section-title">状态管理</span>
                    <span id="wbap-table-status" class="wbap-badge">未启用</span>
                    <div style="flex:1"></div>
                    <label class="wbap-toggle-switch" style="margin-right:8px;">
                        <input type="checkbox" id="wbap-table-enabled">
                        <span class="wbap-toggle-slider"></span>
                    </label>
                    <button id="wbap-table-open-btn" class="wbap-btn wbap-btn-xs wbap-btn-primary"><i class="fa-solid fa-table"></i> 配置</button>
                </div>
                <div class="wbap-text-muted" style="font-size:12px; margin-top:6px;">管理结构化数据（物品/任务/关系/属性），自动同步到世界书。</div>
            </div>
            -->
                ...
                <div class="wbap-card-body">
                    ...
                    <div id="wbap-agent-config-container" class="wbap-agent-config">
                        <div class="wbap-form-row">
                            ...
                            <select id="wbap-agent-endpoint-select" class="wbap-select-modern"></select>
                        </div>
                        <div class="wbap-form-row">
                            <label><i class="fa-solid fa-microchip"></i> 模型</label>
                            <input type="text" id="wbap-agent-model" class="wbap-input-modern" placeholder="留空使用实例默认模型">
                        </div>
            ...
            <div class="wbap-card wbap-card-pedsa">
                ...
                <div class="wbap-card-body">
                    ...
                    <div class="wbap-pedsa-stage wbap-pedsa-stage-2">
                        <div class="wbap-stage-header">
                            <div class="wbap-stage-badge wbap-badge-rust">Rust</div>
                            <div class="wbap-stage-info">
                                <span class="wbap-stage-title">二阶段：PEDSA-Rust</span>
                                <span class="wbap-stage-desc">高性能原生引擎</span>
                            </div>
                            <label class="wbap-toggle">
                        ...
                        <div id="wbap-pedsa-rust-config" class="wbap-rust-config" style="display:none;">
                            <div class="wbap-unlock-row">
                                <input type="password" id="wbap-pedsa-rust-password" class="wbap-input-modern" placeholder="输入解锁密码">
                                <button id="wbap-pedsa-rust-unlock" class="wbap-btn-unlock">
                                    <i class="fa-solid fa-unlock"></i>
                                </button>
                            </div>
                            <div id="wbap-pedsa-rust-status" class="wbap-stats-panel wbap-stats-rust">
                                <div class="wbap-stat-item">
                                    <span class="wbap-stat-label">服务状态</span>
                                    <span id="wbap-pedsa-rust-service-status" class="wbap-stat-value wbap-status-error">未连接</span>
                                </div>
                                <div class="wbap-stat-item">
                                    <span class="wbap-stat-label">服务地址</span>
                                    <span id="wbap-pedsa-rust-url" class="wbap-stat-value wbap-stat-url">localhost:7878</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wbap-card wbap-card-graph">
                ...
                <div class="wbap-card-body">
                    ...
                    <div class="wbap-form-grid">
                        <div class="wbap-form-row">
                            <label><i class="fa-solid fa-server"></i> 维护 API</label>
                            <select id="wbap-graph-update-endpoint" class="wbap-select-modern"></select>
                        </div>
                        <div class="wbap-form-row">
                            <label><i class="fa-solid fa-microchip"></i> 维护模型</label>
                            <input type="text" id="wbap-graph-update-model" class="wbap-input-modern" placeholder="留空使用默认">
                        </div>
                        <div class="wbap-form-row">
        ...
        <div class="wbap-settings-content">
            ...
            <div class="wbap-section">
                ...
                <div class="wbap-form-group" style="margin-top: 10px;">
                    <label>注入字符上限</label>
                    <input type="number" id="wbap-resp-opt-worldbook-max-chars" min="0" max="20000" value="2000" style="width: 140px;">
                    <small class="wbap-text-muted">0 表示不注入内容（仍保留选择列表）。</small>
                </div>
            </div>
    ...
    <div class="wbap-settings-container">
        ...
        <div class="wbap-settings-body">
            ...
            <div class="wbap-table-nav-tabs">
                <div class="wbap-table-nav-tab active" data-nav="setup">
            ...
            <div id="wbap-table-nav-content" class="wbap-table-nav-content">
                <!-- ========== 全局设置 ========== -->
                <div class="wbap-table-nav-panel active" data-panel="setup">
                    <!-- 显示设置 -->
                    <div class="wbap-summary-section">
                        <div class="wbap-summary-section-header">
                            ...
                            <div class="wbap-summary-input-row">
                                <div class="wbap-summary-input-group">
                                    ...
                                    <div style="display:flex; gap:6px; align-items:center;">
                                        <input type="number" id="wbap-batch-start" class="wbap-summary-input" style="width:70px;" placeholder="起始">
                                        <span style="color:var(--wbap-text-muted);">-</span>
                                        <input type="number" id="wbap-batch-end" class="wbap-summary-input" style="width:70px;" placeholder="结束">
                                    </div>
                                </div>
                                <div class="wbap-summary-input-group" style="flex:0;">
                                    <label>&nbsp;</label>
                                    <button id="wbap-run-batch-fill" class="wbap-btn wbap-btn-primary wbap-btn-xs">
                                        <i class="fa-solid fa-play"></i> 执行填表
                                    </button>
                                </div>
                            </div>
                            <div style="margin-top:12px;">
                                <button id="wbap-run-reorg" class="wbap-btn wbap-btn-xs">
                                    <i class="fa-solid fa-wand-magic-sparkles"></i> 智能重整理
                                </button>
                                <div class="wbap-summary-hint" style="margin-top:4px;">合并重复项、优化表格结构</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="wbap-table-nav-panel" data-panel="prompt">
                    <div class="wbap-summary-section">
                        ...
                        <div class="wbap-summary-section-body">
                            ...
                            <div class="wbap-summary-hint" style="margin-top:8px;">
                                <i class="fa-solid fa-info-circle"></i>
                                可用变量: <code>{chat_history}</code> <code>{current_table}</code> <code>{user_name}</code> <code>{char_name}</code>
                            </div>
