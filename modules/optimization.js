        ...
        if (optCfg.useIndependentProfile) {
            const apiConfig = {
                apiConfig: {
                    ...
                    maxRetries: Number.isInteger(optCfg.maxRetries) ? Math.max(0, optCfg.maxRetries) : 2,
                    retryDelayMs: Number.isFinite(optCfg.retryDelayMs) ? optCfg.retryDelayMs : 800,
                    enableStreaming: optCfg.enableStreaming !== false,
                    priority: 'high'
                },
                model: optCfg.model
            };
